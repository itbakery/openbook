class Admin::PricesheetsController < ApplicationController
  # GET /pricesheets
  ...
  def create
    ...
    respond_to do |format|
      if @pricesheet.save
        format.html { redirect_to [:admin,@pricesheet], notice: 'Pricesheet was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @pricesheet.update_attributes(params[:pricesheet])
        format.html { redirect_to [:admin,@pricesheet], notice: 'Pricesheet was successfully updated.' }
