class Admin::ProvincesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @province.save
        format.html { redirect_to [:admin,@province], notice: 'Province was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @province.update_attributes(params[:province])
        format.html { redirect_to [:admin,@province], notice: 'Province was successfully updated.' }
